      ...
      <div class="flex gap-12 flex-wrap lg:flex-nowrap">
        <div class="flex-shrink-0 w-64 flex flex-col items-center gap-6">
          <div class="relative w-56 h-56 bg-white rounded-full overflow-hidden shadow-lg border-4 border-accent-green transition-all duration-300 hover:scale-105 hover:shadow-xl">
            <img src="${userData.avatar || './public/image/default-avatar.png'}" alt="User Avatar" id="user-avatar" class="w-full h-full object-cover transition-all duration-300">
            ${isEditMode ? `
        ...
        <div class="flex-1 min-w-80">
          <div class="flex flex-col gap-4">
            <div class="flex flex-col mb-4">
              ...
              ${isEditMode ? 
                `<input type="text" id="name" class="bg-white border-none rounded-full px-5 py-3 text-base text-gray-800 w-full shadow-sm focus:outline-none focus:ring-2 focus:ring-accent-green" value="${userData.name || ''}" placeholder="Enter your name">` : 
                `<div class="bg-white rounded-full px-5 py-3 text-base text-gray-800 shadow-sm">${userData.name || ''}</div>`
              }
            </div>
              ...
              <div class="flex flex-col flex-1 min-w-52 mb-4">
                ...
                ${isEditMode ? `
                  <div class="flex gap-4">
                    <button class="flex-1 bg-white border-none rounded-full px-5 py-3 text-base text-gray-800 cursor-pointer transition-all duration-200 shadow-sm ${userData.gender === 'male' ? 'bg-accent-green text-white' : 'hover:bg-gray-50'}" id="male-option">
                      <i class="fas fa-male mr-2"></i> I am Male
                    </button>
                    <button class="flex-1 bg-white border-none rounded-full px-5 py-3 text-base text-gray-800 cursor-pointer transition-all duration-200 shadow-sm ${userData.gender === 'female' ? 'bg-accent-green text-white' : 'hover:bg-gray-50'}" id="female-option">
                      <i class="fas fa-female mr-2"></i> I am Female
                    </button>
                  </div>
                ` : `
                  <div class="bg-white rounded-full px-5 py-3 text-base text-gray-800 shadow-sm">${userData.gender === 'male' ? 'I am Male' : userData.gender === 'female' ? 'I am Female' : ''}</div>
                `}
              </div>
              ...
              <div class="flex flex-col flex-1 min-w-52 mb-4">
                ...
                ${isEditMode ? 
                  `<div class="relative flex items-center">
                    <input type="number" id="age" class="bg-white border-none rounded-full px-5 py-3 pr-16 text-base text-gray-800 w-full shadow-sm focus:outline-none focus:ring-2 focus:ring-accent-green" value="${userData.age || ''}" min="1" max="120">
                  ...
                  `<div class="bg-white rounded-full px-5 py-3 text-base text-gray-800 shadow-sm">${userData.age || ''}</div>`
                }
              </div>
            </div>
            ...
            <div class="flex gap-8 flex-wrap">
              <div class="flex flex-col flex-1 min-w-52 mb-4">
                ...
                ${isEditMode ? 
                  `<div class="relative flex items-center">
                    <input type="number" id="weight" class="bg-white border-none rounded-full px-5 py-3 pr-16 text-base text-gray-800 w-full shadow-sm focus:outline-none focus:ring-2 focus:ring-accent-green" value="${userData.weight || ''}" min="1" max="500">
                  ...
                  `<div class="bg-white rounded-full px-5 py-3 text-base text-gray-800 shadow-sm">${userData.weight || ''} kg</div>`
                }
              </div>
              ...
              <div class="flex flex-col flex-1 min-w-52 mb-4">
                ...
                ${isEditMode ? 
                  `<div class="relative flex items-center">
                    <input type="number" id="height" class="bg-white border-none rounded-full px-5 py-3 pr-16 text-base text-gray-800 w-full shadow-sm focus:outline-none focus:ring-2 focus:ring-accent-green" value="${userData.height || ''}" min="1" max="300">
                  ...
                  `<div class="bg-white rounded-full px-5 py-3 text-base text-gray-800 shadow-sm">${userData.height || ''} cm</div>`
                }
              </div>
            </div>
            ...
            <div class="flex gap-8 flex-wrap">
              <div class="flex flex-col flex-1 min-w-52 mb-4">
                ...
                ${isEditMode ? 
                  `<div class="relative flex items-center">
                    <input type="number" id="targetWeight" class="bg-white border-none rounded-full px-5 py-3 pr-16 text-base text-gray-800 w-full shadow-sm focus:outline-none focus:ring-2 focus:ring-accent-green" value="${userData.targetWeight || ''}" min="1" max="500">
                    <span class="absolute right-14 text-gray-500">kg</span>
                    <div class="absolute right-2 flex flex-col gap-0.5">
                  ...
                  `<div class="bg-white rounded-full px-5 py-3 text-base text-gray-800 shadow-sm">${userData.targetWeight || ''} ${userData.targetWeight ? 'kg' : ''}</div>`
                }
              </div>
              ...
              <div class="flex flex-col flex-1 min-w-52 mb-4">
                ...
                ` : `
                  <div class="bg-white rounded-full px-5 py-3 text-base text-gray-800 shadow-sm">${getActivityLevelDisplay(userData.activityLevel)}</div>
                `}
              </div>
            </div>
          </div>
...
export default {
  ...
  toggleHeaders(showProfileHeader = true) {
    // CLEANUP: Hapus semua profile headers yang ada (untuk avoid duplikasi)
    const existingProfileHeaders = document.querySelectorAll('.kalkulori-profile-header');
    ...
    if (showProfileHeader) {
      ...
      // Profile headers sudah di-cleanup di atas
    }
  },
  ...
  toggleGenderOption(gender) {
    ...
    if (gender === 'male') {
      maleOption.className = 'flex-1 bg-accent-green text-white border-none rounded-full px-5 py-3 text-base cursor-pointer transition-all duration-200 shadow-sm';
      femaleOption.className = 'flex-1 bg-white text-gray-800 border-none rounded-full px-5 py-3 text-base cursor-pointer transition-all duration-200 shadow-sm hover:bg-gray-50';
    } else if (gender === 'female') {
      femaleOption.className = 'flex-1 bg-accent-green text-white border-none rounded-full px-5 py-3 text-base cursor-pointer transition-all duration-200 shadow-sm';
      maleOption.className = 'flex-1 bg-white text-gray-800 border-none rounded-full px-5 py-3 text-base cursor-pointer transition-all duration-200 shadow-sm hover:bg-gray-50';
    }
  },
  ...
  attachEventHandlers(handlers) {
    ...
    // Number controls dengan data attributes
    ...
    // Handle camera modal buttons visibility
